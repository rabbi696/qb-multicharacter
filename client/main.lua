...
Config = {
    PedCoords = {x = -813.7346, y = 176.9999, z = 76.74, h = -7.5, r = 1.0}, 
    HiddenCoords = {x = -812.23, y = 182.54, z = 76.74, h = 156.5, r = 1.0}, 
    CamCoords = {x = -819.02, y = 179.56, z = 76.74, h = 198.5, r = 1.0}, 
}
...
RegisterNUICallback('selectCharacter', function(data)
    ...
    DoScreenFadeIn(500)
	    Citizen.Wait(2300)
                                    local lib, anim = 'mp_character_creation@lineup@male_a', 'outro' do
												RequestAnimDict("mp_character_creation@lineup@male_a")
				while not HasAnimDictLoaded("mp_character_creation@lineup@male_a") do
					Citizen.Wait(100)
				end                                    
                                    TaskPlayAnim(charPed, "mp_character_creation@lineup@male_a", "outro", 8.0, -8.0, -1, 0, 0, false, false, false)	
                                    Citizen.Wait(10)          
                                    end
    cam2 = CreateCamWithParams("DEFAULT_SCRIPTED_CAMERA", -813.46, 180.45, 76.85, 5.0 ,0.0, 174.5, 70.00, false, 0) -- Kamera Geçişi
    PointCamAtCoord(cam2, -813.46, 180.45, 76.85) -- Kamera Geçişi
    SetCamActiveWithInterp(cam2, cam, 3500, true, true)
    cam3 = CreateCamWithParams("DEFAULT_SCRIPTED_CAMERA", -812.56, 180.45, 76.85, 5.0 ,0.0, 174.5, 70.00, false, 0) -- Kamera Geçişi
    PointCamAtCoord(cam2, -812.56, 180.45, 76.85) -- Kamera Geçişi
    SetCamActiveWithInterp(cam3, cam2, 4500, true, true)
    Citizen.Wait(5300)
